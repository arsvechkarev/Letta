...
import com.arsvechkarev.letta.openglcanvas.Action
import com.arsvechkarev.letta.openglcanvas.Logger
import com.arsvechkarev.letta.openglcanvas.brushes.Brush
import com.arsvechkarev.letta.openglcanvas.shaders.BLIT
import com.arsvechkarev.letta.openglcanvas.shaders.BLIT_WITH_MASK
import com.arsvechkarev.letta.openglcanvas.shaders.BLIT_WITH_MASK_LIGHT
import com.arsvechkarev.letta.openglcanvas.shaders.COLOR
import com.arsvechkarev.letta.openglcanvas.shaders.COMPOSITE_WITH_MASK
import com.arsvechkarev.letta.openglcanvas.shaders.COMPOSITE_WITH_MASK_LIGHT
import com.arsvechkarev.letta.openglcanvas.shaders.MASK
import com.arsvechkarev.letta.openglcanvas.shaders.MVP_MATRIX
import com.arsvechkarev.letta.openglcanvas.shaders.NON_PRE_MULTIPLIED_BLIT
import com.arsvechkarev.letta.openglcanvas.shaders.Shader
import com.arsvechkarev.letta.openglcanvas.shaders.Shaders
import com.arsvechkarev.letta.openglcanvas.shaders.TEXTURE
...
class Painting(
  ...
  fun paintStroke(path: Path, clearBuffer: Boolean, action: Action) {
    drawingView.performInEGLContext {
      activePath = path
      ...
      if (status == GLES20.GL_FRAMEBUFFER_COMPLETE) {
        ...
        if (brushTexture == null) {
          brushTexture = Texture(brush.getStamp(drawingView.context.resources))
        }
