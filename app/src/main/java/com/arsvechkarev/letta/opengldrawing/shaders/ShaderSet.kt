...
object ShaderSet {
  ...
  private fun createMap(): Map<String, Map<String, Any>> {
    ...
    shader[UNIFORMS] = arrayOf(MVP_MATRIX, TEXTURE)
    ...
    shader[ATTRIBUTES] = arrayOf("inPosition", "inTexcoord", "alpha")
    shader[UNIFORMS] = arrayOf(MVP_MATRIX, TEXTURE)
    result[BRUSH_LIGHT] = Collections.unmodifiableMap(shader)
    shader = HashMap()
    ...
    shader[ATTRIBUTES] = arrayOf("inPosition", "inTexcoord")
    shader[UNIFORMS] = arrayOf(MVP_MATRIX, TEXTURE, MASK, COLOR)
    result[BLIT_WITH_MASK_LIGHT] = Collections.unmodifiableMap(shader)
    shader = HashMap()
    shader[VERTEX] = BLIT_VSH
    shader[FRAGMENT] = BLIT_WITH_MASK_FSH
    shader[ATTRIBUTES] = arrayOf("inPosition", "inTexcoord")
    shader[UNIFORMS] = arrayOf(MVP_MATRIX, TEXTURE, MASK, COLOR)
    result[BLIT_WITH_MASK] = Collections.unmodifiableMap(shader)
    shader = HashMap()
    shader[VERTEX] = BLIT_VSH
    shader[FRAGMENT] = COMPOSITE_WITH_MASK_FSH
    shader[ATTRIBUTES] = arrayOf("inPosition", "inTexcoord")
    shader[UNIFORMS] = arrayOf(MVP_MATRIX, MASK, COLOR)
    result[COMPOSITE_WITH_MASK] = Collections.unmodifiableMap(shader)
    shader = HashMap()
    shader[VERTEX] = BLIT_VSH
    shader[FRAGMENT] = COMPOSITE_WITH_MASK_LIGHT_FSH
    shader[ATTRIBUTES] = arrayOf("inPosition", "inTexcoord")
    shader[UNIFORMS] = arrayOf(MVP_MATRIX, TEXTURE, MASK, COLOR)
    result[COMPOSITE_WITH_MASK_LIGHT] = Collections.unmodifiableMap(shader)
    shader = HashMap()
    shader[VERTEX] = BLIT_VSH
    shader[FRAGMENT] = NON_PRE_MULTIPLIED_BLIT_FSH
    shader[ATTRIBUTES] = arrayOf("inPosition", "inTexcoord")
    shader[UNIFORMS] = arrayOf(MVP_MATRIX, TEXTURE)
    result[NON_PRE_MULTIPLIED_BLIT] = Collections.unmodifiableMap(shader)
