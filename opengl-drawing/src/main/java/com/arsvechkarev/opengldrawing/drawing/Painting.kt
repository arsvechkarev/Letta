...
import com.arsvechkarev.opengldrawing.Action
import com.arsvechkarev.opengldrawing.Brush
import com.arsvechkarev.opengldrawing.Logger
import com.arsvechkarev.opengldrawing.multiplyMatrices
import com.arsvechkarev.opengldrawing.orthoM
import com.arsvechkarev.opengldrawing.shaders.BLIT
import com.arsvechkarev.opengldrawing.shaders.BLIT_WITH_MASK
import com.arsvechkarev.opengldrawing.shaders.BRUSH
import com.arsvechkarev.opengldrawing.shaders.COLOR
import com.arsvechkarev.opengldrawing.shaders.COMPOSITE_WITH_MASK
import com.arsvechkarev.opengldrawing.shaders.MASK
import com.arsvechkarev.opengldrawing.shaders.MVP_MATRIX
import com.arsvechkarev.opengldrawing.shaders.NON_PRE_MULTIPLIED_BLIT
import com.arsvechkarev.opengldrawing.shaders.Shader
import com.arsvechkarev.opengldrawing.shaders.Shaders
import com.arsvechkarev.opengldrawing.shaders.TEXTURE
...
class Painting(
  ...
  private var openGLDrawingView: OpenGLDrawingView?,
  ...
  fun paintStroke(path: Path, clearBuffer: Boolean, action: Action) {
    openGLDrawingView!!.performInEGLContext {
      ...
      if (status == GLES20.GL_FRAMEBUFFER_COMPLETE) {
        ...
        val shader = shaders.getValue(BRUSH)
  ...
  fun commitStroke(color: Int) {
    openGLDrawingView!!.performInEGLContext {
      ...
      update {
        val shader = shaders.getValue(COMPOSITE_WITH_MASK)
    
        GLES20.glUseProgram(shader.program)
    
        GLES20.glUniformMatrix4fv(shader.getUniform(MVP_MATRIX), 1, false,
          FloatBuffer.wrap(projection))
  ...
  private fun render(mask: Int, color: Int) {
    val shader = shaders.getValue(BLIT_WITH_MASK)
